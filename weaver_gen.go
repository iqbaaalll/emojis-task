...
func init() {
	codegen.Register(codegen.Registration{
		Name:   "emojis-demo/Cache",
		Iface:  reflect.TypeOf((*Cache)(nil)).Elem(),
		Impl:   reflect.TypeOf(cache{}),
		Routed: true,
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return cache_local_stub{impl: impl.(Cache), tracer: tracer, getMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "emojis-demo/Cache", Method: "Get", Remote: false}), putMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "emojis-demo/Cache", Method: "Put", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return cache_client_stub{stub: stub, getMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "emojis-demo/Cache", Method: "Get", Remote: true}), putMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "emojis-demo/Cache", Method: "Put", Remote: true})}
		},
	...
	codegen.Register(codegen.Registration{
		Name:  "emojis-demo/ChatGPT",
		Iface: reflect.TypeOf((*ChatGPT)(nil)).Elem(),
		Impl:  reflect.TypeOf(chatgpt{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return chatGPT_local_stub{impl: impl.(ChatGPT), tracer: tracer, completeMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "emojis-demo/ChatGPT", Method: "Complete", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return chatGPT_client_stub{stub: stub, completeMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "emojis-demo/ChatGPT", Method: "Complete", Remote: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
	...
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦d94657f8:wEaVeReDgE:github.com/ServiceWeaver/weaver/Main→emojis-demo/Searcher⟧\n⟦a234aa48:wEaVeRlIsTeNeRs:github.com/ServiceWeaver/weaver/Main→emojis⟧\n",
	})
	codegen.Register(codegen.Registration{
		Name:  "emojis-demo/Searcher",
		Iface: reflect.TypeOf((*Searcher)(nil)).Elem(),
		Impl:  reflect.TypeOf(searcher{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return searcher_local_stub{impl: impl.(Searcher), tracer: tracer, searchMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "emojis-demo/Searcher", Method: "Search", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return searcher_client_stub{stub: stub, searchMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "emojis-demo/Searcher", Method: "Search", Remote: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
			return searcher_server_stub{impl: impl.(Searcher), addLoad: addLoad}
		},
		RefData: "⟦e11e4970:wEaVeReDgE:emojis-demo/Searcher→emojis-demo/Cache⟧\n",
	})
}
